...
export const metadata = {
  title: "Privacy Policy - Techanic Infotech",
  description:
    "Your privacy is important to Techanic Infotech. This Privacy Policy describes what personal information of our website visitors is collected and how and when it might be used or shared by us.",
    alternates: {
      canonical: new URL('https://www.techanicinfotech.com/privacy-policy'),
    },
    robots: "index, follow",
  };
  ...
  return (
    ...
    <div className="w-full">
      <div className=" bg-gradient-to-r from-[#3d3e3e] via-[#707171] to-[#8d8d8f] h-[500px] flex justify-start px-[20px] lg:px-[60px] items-center text-start ">
        <h1 className="max-w-[1420px] mx-auto  text-3xl  md:text-4xl lg:text-5xl 2xl:text-6xl font-bold text-white ">Privacy Policy</h1>
      </div>

      <div className="max-w-[1420px] flex flex-col gap-4 mx-auto p-8 ">
        <div className="flex flex-col gap-4">
          <p className="text-lg">Last updated: February 02, 2024</p>
        <p className="text-lg">
            This Privacy Policy describes Our policies and procedures on the collection, use, and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
          </p>
          </div>
          <div className="flex flex-col gap-4">
          <h2 className=" text-2xl lg:text-3xl font-bold">Interpretation and Definitions</h2>
          <h3 className="text-xl lg:text-2xl font-semibold">Interpretation</h3>
        <p className="text-lg">The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
          <h4 className="text-xl lg:text-2xl font-semibold">Definitions</h4>
        <p className="text-lg">For the purposes of this Privacy Policy:</p>
         <ol className="list-disc ml-6">
            ...
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Techanic Infotech, 3101 N. Central Ave, STE 183#3541, Phoenix, Arizona, 85012, USA.</li>
            ...
            <li><strong>Website</strong> refers to Techanic Infotech, accessible from <Link href="/">https://techanicinfotech.com/</Link></li>
            <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
          </ol>
          </div>
          <div className="flex flex-col gap-4">
          <h2 className=" text-2xl lg:text-3xl font-bold">Collecting and Using Your Personal Data</h2>
              <h3 className="text-xl lg:text-2xl font-semibold">Types of Data Collected</h3>
        <h4 className="text-xl lg:text-2xl font-semibold">Personal Data</h4>
        ...
        <h4 className="text-xl lg:text-2xl font-semibold">Usage Data</h4>
        ...
        <h4 className="text-xl lg:text-2xl font-semibold">Tracking Technologies and Cookies</h4>
        ...
        <p className="text-lg">We use both Session and Persistent Cookies for the purposes set out below:</p>
          <div>
           <ol className="list-disc ml-6">
              ...
              <p className="text-lg">Purpose: These Cookies are
          ...
          <div>
           <ol className="list-disc ml-6">
              ...
              <h3 className="text-xl lg:text-2xl font-semibold">Use of Your Personal Data</h3>
        ...
        <p className="text-lg">We may share Your personal information in the following situations:</p>
         <ol className="list-disc ml-6">
            ...
            <li><strong>With Your consent</strong>: We may disclose Your personal information for any other purpose with Your consent.</li>
              ...
              <h3 className="text-xl lg:text-2xl font-semibold">Retention of Your Personal Data</h3>
        ...
        <p className="text-lg">The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer time periods.</p>
              <h3 className="text-xl lg:text-2xl font-semibold">Transfer of Your Personal Data</h3>
        ...
        <p className="text-lg">The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy Policy and no transfer of Your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of Your data and other personal information.</p>
              <h3 className="text-xl lg:text-2xl font-semibold">Delete Your Personal Data</h3>
        ...
        <p className="text-lg">Please note
          , however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so.</p>
              <h3 className="text-xl lg:text-2xl font-semibold">Disclosure of Your Personal Data</h3>
        <h4 className="text-xl lg:text-2xl font-semibold">Business Transactions</h4>
        ...
        <h4 className="text-xl lg:text-2xl font-semibold">Law Enforcement</h4>
        ...
        <h4 className="text-xl lg:text-2xl font-semibold">Other Legal Requirements</h4>
        <p className="text-lg">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
         <ol className="list-disc ml-6">
            ...
            <li>Protect against legal liability</li>
              ...
              <h3 className="text-xl lg:text-2xl font-semibold">Security of Your Personal Data</h3>
        ...
        <p className="text-lg">If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent's consent before We collect and use that information.</p>
          <h2 className=" text-2xl lg:text-3xl font-bold">Links to Other Websites</h2>
        ...
        <p className="text-lg">If you have any questions about this Privacy Policy, You can contact us:</p>
         <ol className="list-disc ml-6">
            <li>By email: support@techanicinfotech.com</li>
          </ol>
        </div>
      </div>
    </div>
